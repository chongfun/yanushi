module Accounting
  class ChartOfAccounts
    ...
    SYSTEM_ACCOUNTS = [
      ...
      { key: "expense_auto_travel", name: "Auto and Travel", account_type: "expense" }.freeze,
      { key: "expense_cleaning_maintenance", name: "Cleaning and Maintenance", account_type: "expense" }.freeze,
      { key: "expense_commissions", name: "Commissions", account_type: "expense" }.freeze,
      ...
      { key: "expense_mortgage_interest", name: "Mortgage Interest", account_type: "expense" }.freeze,
      { key: "expense_other_interest", name: "Other Interest", account_type: "expense" }.freeze,
