...
ActiveRecord::Schema[8.1].define(version: 2026_05_20_050506) do
  ...
  create_table "payment_receipt_ingestions", force: :cascade do |t|
    t.decimal "amount", precision: 12, scale: 2
    ...
    t.index ["lease_id"], name: "index_payment_receipt_ingestions_on_lease_id"
    t.index ["tenant_id"], name: "index_payment_receipt_ingestions_on_tenant_id"
    t.index ["tenant_payment_id"], name: "index_payment_receipt_ingestions_on_tenant_payment_id"
    t.index ["user_id"], name: "index_payment_receipt_ingestions_on_user_id"
  end
  ...
  add_foreign_key "payment_receipt_ingestions", "leases"
  add_foreign_key "payment_receipt_ingestions", "tenant_payments"
  add_foreign_key "payment_receipt_ingestions", "tenants"
  add_foreign_key "payment_receipt_ingestions", "users"
